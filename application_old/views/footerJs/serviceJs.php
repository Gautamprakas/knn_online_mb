...
jQuery(document).ready(function() {
	...
	$("#country_id").keyup(function(){
		...
		var cid=$("#country_id").val();
		$.post("<?php echo site_url("serviceController/printServiceRecord");?>", {cid : cid}, function(data){
			$("#valtable").html(data);
		});
	});	
	...
	$("#box_no").keyup(function(){
		...
		var cid=$("#box_no").val();
		$.post("<?php echo site_url("serviceController/printServiceRecordbox");?>", {cid : cid}, function(data){
			$("#valtable").html(data);
		});
	});
