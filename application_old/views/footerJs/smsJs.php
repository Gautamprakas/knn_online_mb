...
$("#sms_not_receieve").click(function(){
	var message = $("#sms_not_receieve").val();
	$.post("<?php echo site_url('index.php/smsControllers/smsSetting') ?>", {message : message},function(data){
		$("#smsSetting").html(data);
	});
});
$("#leave").click(function(){
	var message = $("#leave").val();
	$.post("<?php echo site_url('index.php/smsControllers/smsSetting') ?>", {message : message},function(data){
		$("#smsSetting").html(data);
	});
});
$("#karyavahi").click(function(){
	var message = $("#karyavahi").val();
	$.post("<?php echo site_url('index.php/smsControllers/smsSetting') ?>", {message : message},function(data){
		$("#smsSetting").html(data);
	});
		});
