...
<html>
<head><!-- Title -->
        <title><?php echo "Grievance Solutions, Pithoragarh"; ?></title>
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo base_url();?>apanel/index" class="logo-text"><span><?php echo "Grievance Solutions, Pithoragarh";?></span></a>
                    </div><!-- Logo Box -->
