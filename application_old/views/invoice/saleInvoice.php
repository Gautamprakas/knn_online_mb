	...
	<div id="page-wrap">
		...
		<table id="items" style="border: 1px solid #000;">
		  ...
		  <tr style="border: 1px solid #000;">
               ...
               <th width="11%" style="border: 1px solid #000;">Sub Total</th>
		  </tr>
		  <?php 
		  	$i = 1;
		  	$count_dis = 0;
		  ...
		  <tr class="item-row">
		      ...
		      <td style="border: 1px solid #000;"><?php echo $row->product_id;?></td>
		      <td style="border: 1px solid #000;">
		      	<?php 
		      		$this->db->where("item_no",$row->product_id);
		      		$pro = $this->db->get("enter_stock")->row();
		      		
		      		echo $pro->name.", ".$row->company_name;
		      	?>
		      </td>
		      <td style="border: 1px solid #000;"><?php echo $row->product_quantity; ?></td>
		  ...
		  <td class="total-line" colspan="2"><strong>Output VAT </strong></td>
		      ...
		      <td style="border: 1px solid #000;"><div id="total"></div><?php $vas = ($printvat->vat_rs*$printvat->total)/100; echo $vas;?></td>
		         ...
		         <tr>
              <td class="total-line" colspan="2"><strong>Total Discount</strong></td>
               <td class="total-value"><div id="total"></div></td>
		      <td class="total-value"><div id="total"></div></td>
		      <td class="total-value"><div id="total"></div></td>
		      <td class="total-value"><div id="total"></div></td>
		   ...
		   <tr>
		      <td colspan="7" align="center" style="border: 1px solid #000;"><strong>Total</strong></td>
		       
		      <td style="border: 1px solid #000;" ><?php echo $total_info->total; ?></td>
		  </tr>
          
		  <tr>
		      <td colspan="7" align="center" style="border: 1px solid #000;"><strong>Amount Paid</strong></td>
