<div class="page-content-inner">
            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Grievance Detail</div>
                        <div class="tools">
...
<?php endif; ?>
	...
	<div class="col-sm-12 form-group">
		<div class="col-sm-6">
			 ...
			 <div class="col-sm-6" >
				 <?php if($row->forward_count != 3 && isset($fc)) echo $rows[$fc]->comment; ?>
				 <?php unset($fc); ?>
			 </div>		
		</div>
		<div class="col-sm-6">
			 ...
			 <div class="col-sm-6" style="color: green;font-weight: bold;">
