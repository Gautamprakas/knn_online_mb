                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                 <center> <div class="btn btn-success">
                                   		<h4>कार्यवाही लंबित (Beyond Time Limit)</h4>
                                   	</div>  
                                   	</center>
...
<?php 
          ...
          if($remaining_days < 0)
          {
             $remng =  "Beyond ".abs($remaining_days)." days";
          }
          else
          {
             $remng = "Time Not Over";
          }
          if( $remng != "Time Not Over" ){
?>                                         

                                            <tr style="background: #b1d9f4;">
                                                <td><?php echo ++$i;?></td>
                                                <td>
