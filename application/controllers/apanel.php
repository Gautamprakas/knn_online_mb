...
class Apanel extends CI_Controller{
	...
	function index(){
		...
		$data['pageTitle'] = 'Overview of all zones';
	...
	function grievance(){
		$data['subPage'] = '';
		$data['smallTitle'] = 'Knn File Management';
		$data['pageTitle'] = 'Knn File Management';
		$data['title'] = 'Work | Display';
		$data['headerCss'] = 'headerCss/listCss';
		$data['footerJs'] = 'footerJs/reportJs';
		$data['mainContent'] = 'Knn File Management';
		$this->load->view("include/template", $data);
	}
	...
	function officerAns(){
		if($this->input->post("complain_Number")){
			...
			$data['smallTitle'] = 'Knn File Management';
			$data['pageTitle'] = 'Knn File Management';
			$data['title'] = 'Work | Officer Answer';
			$data['headerCss'] = 'headerCss/listCss';
			$data['footerJs'] = 'footerJs/reportJs';
	...
	function getfilelist(){
		...
		?><div>
			...
			function cws(){
				...
				$data['smallTitle'] = 'Knn File Management';
				$data['pageTitle'] = 'Knn File Management';
				$data['title'] = 'Work | Complain with Status';
				$data['headerCss'] = 'headerCss/listCss';
				$data['footerJs'] = 'footerJs/reportJs';
	...
	{
		$data['pageTitle'] = "Knn File Management Panel";
		$data['smallTitle'] = "Knn File Management  / Knn File Management Panel";
		$data['subPage'] = "Knn File Management Panel";
