<div class="page-content-inner">
            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form" style="background: #ffcccc;">
<?php
...
<form class="form-horizontal" action="<?php echo base_url("index.php/grievanceController/unredressedInsert")?>" method="post" enctype="multipart/form-data">
