<div class="page-content-inner"> 
            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Change Status of Work </div>
                        <div class="tools">
...
<form class="form-horizontal" action="<?php echo base_url("index.php/grievanceController/pendingInsert")?>" method="post" enctype="multipart/form-data" onsubmit="hideSubmit();" >
	...
	<div class="col-sm-12 form-group">
		...
		<div class="col-sm-6">
		     <label class="col-sm-4 ">
			      Work Number  <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
		...
		<div class="col-sm-6">
		     <label class="col-sm-4 ">
			     Recommended by  <span class="symbol required"></span>
		    </label>
			<div class="col-sm-6" >
	...
	<div class="col-sm-12 form-group">
		...
		<div class="col-sm-6">
		     <label class="col-sm-4 ">
			      Work Date  <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
				 <?php echo strtotime($rows[0]->complain_date) > 0 ? $rows[0]->complain_date : ''; ?>
			 </div>		
		</div>
...
<input type="text" id="subject" value="<?php echo $rows[0]->complain; ?>" hidden	>
	<div class="col-sm-12 form-group">

		<div class="col-sm-6">
		     <label class="col-sm-4 ">
			      Work  <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
		...
		<div class="col-sm-6">
		     <label class="col-sm-4 ">
			      Work Type  <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
	...
	<div class="col-sm-12 form-group">
		<div class="col-sm-6">
		     <label class="col-sm-4">
			      Work File <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
		...
		<div class="col-sm-6">
		     <label class="col-sm-4">
			      Work Status <span class="symbol required"></span>
		     </label>
			 <div class="col-sm-6" >
...
<?php endforeach;*/ ?>
                  ...
                  <?php if(1==1 || strtotime($row->complain_date)>strtotime("2018-03-07")){ ?> 
                               ...
                               <div class="col-sm-12 form-group">
									...
									<div class="col-sm-6">
										 <select class="form-control  m-b-sm" name="complain_type" required="required">
							...
							<!-- <div class="col-sm-12 form-group">
								...
								<!-- <div class="col-sm-12 form-group">
								<label class="col-sm-4 control-label">
									Write Work (MM: 500 char) <span class="symbol required">*</span>
									</label>
									<div class="col-sm-6">
										<textarea rows="3" name = "complain" class="form-control  m-b-sm " required="required" cols="1" id="complain"></textarea>  
									</div>	
								</div> -->
				<?php } ?>				
...
<div id="commentContainer">
								...
								<div class="col-sm-6">
								<select class="form-control m-b-sm multilist" multiple="multiple" id="dep" name="dep[]" required="required">
								...
								<div class="col-sm-12 form-group">
								<label class="col-sm-4 control-label">
									Write Comment(MM: 500 char) <span class="symbol required">*</span>  
									</label>
									<div class="col-sm-6">
...
<div id="explainationContainer">
	                          <div class="col-sm-12 form-group">
								<label class="col-sm-4 control-label">
									Explaination(MM: 500 char) <span class="symbol required">*</span> 
									</label>
									<div class="col-sm-6">
