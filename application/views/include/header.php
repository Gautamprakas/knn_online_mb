        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo base_url();?>apanel/index" class="logo-text"><span><?php echo PROJECT_NAME; ?></span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-inner">
                ...
                <div class="page-title">
                    <div class="container">
                        <h3 style="display:inline-block;"><?php echo $pageTitle; ?></h3>
                        
                        <button onclick="window.close();" style="float: right;">Close</button>
                        <button onclick="window.history.back();" style="float: right;">Go Back</button>
                    </div>
                </div>