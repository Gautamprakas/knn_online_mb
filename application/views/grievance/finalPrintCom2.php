		...
		<table style="width:100%; margin: auto">
			<tr>
				<td style="border: none;">
					<h3 align="center" style="text-transform:uppercase;font-size: 70%;font-weight: bold;"><?php echo "कानपुर नगर निगम"; ?></h3>
...
<table align="center" style="width:100%;margin: 1% 0px 0px 0px;font-size :70%;font-weight: 400">
	...
	<tr>
		<td colspan="2" style="text-align: center">
			<strong style="font-weight: bold;">भवदीय</strong><br/>कानपुर नगर निगम
		</td>
	</tr>
</table>		
