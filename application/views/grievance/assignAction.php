					...
					<form class="form-horizontal" action="<?php echo base_url("index.php/grievanceController/solvedGrievance")?>" method="post" enctype="multipart/form-data">
                              ...
                              <div class="col-sm-12 form-group">
								...
								<label class="col-sm-4 control-label">
									...
									<div class="col-sm-6">
										<textarea rows="3" name = "explaination" class="form-control  m-b-sm " required="required" cols="1"></textarea>  
									</div>	
								</div>
								...
								<div >
								 <div class="form-group form-group">
                                    <div class="col-sm-offset-5 col-sm-2">
                                        ...
                                        <button type="submit" id="submitLeave" class="btn btn-success">Solved</button>
                                    </div>
                                </div>
