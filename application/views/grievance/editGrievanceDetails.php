<div class="page-content-inner">
            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Welcome To Work Panel  </div>
                        <div class="tools">
                               ...
                               <div class="col-sm-12 form-group">
                               	<br><br>
									<label class="col-sm-4 control-label">
										Enter Work Number<span class="symbol required"></span>
									</label>
									<div class="col-sm-4 " >
										<input type="text"  id = "gid" name ="gid" class="form-control m-b-sm" required="required" 
